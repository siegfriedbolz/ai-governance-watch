...
| [Art. 15](https://artificialintelligenceact.eu/article/15/) (accuracy/robustness/cyber) | [MEASURE](https://airc.nist.gov/airmf-resources/playbook/measure/) | Cl. 8 + Annex A | Annex B (security & robustness) |
...
| ---- | -------- | ------------ |
| `2026-09-05` (2) | substantive | **Enforcement started.** Commission release of 2026-07-31: from **2026-08-02** the AI Office and national authorities enforce the Act; Art. 50 transparency duties apply; a **first list of more than 180 signatories** of the Code of Practice on transparency of AI-generated content is public; complaints tool, whistleblower tool and a GPAI downstream-provider complaints channel are live. Related: the **EU Action Plan on Cybersecurity and AI** (2026-07-07). Application timeline unchanged. |
...
| `2026-09-05` | editorial | Added the Council of Europe link: Council Decision (EU) 2026/1080 implements the CETS 225 Convention in the EU exclusively through the AI Act — see the new [CETS 225 page](reference_coe_ai_convention.md). |
